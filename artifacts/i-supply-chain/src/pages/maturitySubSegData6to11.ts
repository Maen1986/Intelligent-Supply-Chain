    ...
    questions: [
      {
        ...
        levelsAr: [
          ...
          'خط الأساس البيئي الشامل للطاقة والمياه والنفايات موثّق للمرافق الرئيسية؛ وتُراجَع البيانات سنويًا وتُرفَع لإدارة الوظيفة.',
    ...
    questions: [
      {
        ...
        levelsAr: [
          ...
          'خارطة المشهد التقني مكتملة؛ والأنظمة الرئيسية وحالة تكاملها والفجوات الكبرى موثّقة؛ وحالة أعمال للاستثمار مُعدَّة لأولى الأولويات.',
    ...
    questions: [
      {
        ...
        levels: [
          ...
          'ML-powered forecasting models are deployed and continuously refined; MAPE is benchmarked against industry leaders; statistical model selection is automated by SKU attribute; forecast bias is near-zero.',
        ],
        levelsAr: [
          ...
          'نماذج تنبؤ مدفوعة بتعلّم الآلة مُنشَرة ومُحسَّنة باستمرار؛ وMAPE تُقارَن معياريًا بقادة القطاع؛ وانتقاء النماذج الإحصائية آلي حسب خصائص SKU؛ وانحياز التنبؤ شبه معدوم.',
        ],
      },
      {
    ...
    questions: [
      {
        ...
        levelsAr: [
          'مخزون الأمان يستند إلى الحدس أو قواعد أيام ثابتة للإمداد مُطبَّقة بشكل موحّد. لا تحليل إحصائي لتقلّب الطلب أو مهل التوريد يُستخدَم.',
...
export const LOGISTICS_SUB_SEGMENTS: SubSegmentData[] = [
    ...
    questions: [
      {
        ...
        levels: [
          'Logistics providers are engaged without formal SLA agreements. Performance is not measured and problems are resolved informally.',
          'Some performance KPIs exist (e.g., on-time delivery rate) but SLAs are incomplete, reviews are infrequent, and non-performance has no defined consequences.',
          'All significant logistics providers are contracted with formal SLAs including defined KPIs, reviewed at least quarterly; corrective action processes are documented.',
          'A carrier and 3PL performance management system tracks KPIs monthly; performance is benchmarked against contract and market standards; a formal escalation and exit protocol is in place.',
          'All carriers and 3PLs are governed through multi-tier SLAs with automated KPI dashboards; monthly performance reviews link to incentive/penalty mechanisms; strategic 3PL partners participate in annual supply chain strategy sessions.',
        ],
        levelsAr: [
          'مزوّدو اللوجستيات يُشارَكون دون اتفاقيات SLA رسمية. الأداء لا يُقاس والمشكلات تُحلّ بشكل غير رسمي.',
          'بعض مؤشرات الأداء موجودة (كمعدل التسليم في الوقت) لكن SLAs غير مكتملة والمراجعات متفرقة وضعف الأداء ليس له عواقب محددة.',
          'جميع مزوّدي اللوجستيات الجوهريين متعاقَد معهم بـ SLAs رسمية تشمل مؤشرات محددة تُراجَع ربع سنويًا على الأقل؛ وعمليات التصحيح موثّقة.',
          'نظام إدارة أداء الناقلين و3PL يتتبّع المؤشرات شهريًا؛ والأداء مُقارَن معياريًا بمعايير العقد والسوق؛ وبروتوكول تصعيد وخروج رسمي قائم.',
          'جميع الناقلين و3PL محكومون بـ SLAs متعددة المستويات مع لوحات معلومات مؤشرات آلية؛ ومراجعات الأداء الشهرية مرتبطة بآليات حوافز/عقوبات؛ وشركاء 3PL الاستراتيجيون يشاركون في جلسات استراتيجية سلسلة الإمداد السنوية.',
        ],
      },
    ],
  },
  ...
  /* ── 9-2  Last-mile & Distribution Network ──────────────────────────── */
  {
    ...
    hint: 'Assesses last-mile delivery performance, distribution network design, and the use of technology to improve delivery success rates and customer experience.',
    hintAr: 'يقيس أداء توصيل الميل الأخير وتصميم شبكة التوزيع واستخدام التقنية لتحسين معدلات نجاح التوصيل وتجربة العملاء.',
    benchmarks: { gcc: 2.4, topQuartile: 4.0 },
    industryWeights: {
    ...
    questions: [
      {
        q: 'How mature is your last-mile delivery operation — measuring first-attempt delivery success rates, customer satisfaction, cost-per-delivery, and the use of route optimisation technology?',
        qAr: 'ما مدى نضج عمليات توصيل الميل الأخير لديكم — بقياس معدلات نجاح التوصيل من أول محاولة ورضا العملاء والتكلفة لكل عملية توصيل واستخدام تقنية تحسين المسار؟',
        levels: [
          'Last-mile delivery is outsourced entirely with no performance tracking. Customer delivery issues are resolved reactively with no SLA.',
          'Basic delivery success rates are tracked for major routes but no route density optimisation, customer pre-notification, or sustainability considerations are applied.',
          'Last-mile KPIs (first-attempt delivery rate, customer satisfaction) are tracked; route density analysis is conducted periodically; customers are notified of major delays.',
          'Route optimisation tools improve delivery density; first-attempt delivery rate ≥90%; real-time customer tracking is available; delivery failure root causes are analysed and acted upon.',
          'AI-optimised last-mile routing achieves ≥97% first-attempt delivery; real-time customer tracking with dynamic rescheduling; sustainable delivery options (EV, consolidation points) are deployed and tracked for CO₂ impact.',
        ],
        levelsAr: [
          'توصيل الميل الأخير مُعهَد به خارجيًا بالكامل دون متابعة أداء. مشكلات توصيل العملاء تُعالَج تفاعليًا دون SLA.',
          'معدلات نجاح التوصيل الأساسية متابَعة للمسارات الرئيسية لكن لا تحليل كثافة مسار أو إخطار مسبق للعملاء أو اعتبارات استدامة.',
          'مؤشرات الميل الأخير (معدل التوصيل من أول محاولة ورضا العملاء) متابَعة؛ وتحليل كثافة المسار يُجرى دوريًا؛ والعملاء يُخطَرون بالتأخيرات الجوهرية.',
          'أدوات تحسين المسار تُحسّن كثافة التوصيل؛ ومعدل التوصيل من أول محاولة ≥90%؛ وتتبّع العملاء الآني متاح؛ والأسباب الجذرية لفشل التوصيل تُحلَّل وتُعالَج.',
          'توجيه مُحسَّن بالذكاء الاصطناعي للميل الأخير يحقق ≥97% تسليم من أول محاولة؛ وتتبّع آني للعملاء مع إعادة جدولة ديناميكية؛ وخيارات توصيل مستدامة (EV ونقاط توحيد) مُنشَأة ومتابَعة لأثر CO₂.',
        ],
      },
    ],
  },
...
export const ORG_TALENT_SUB_SEGMENTS: SubSegmentData[] = [
    ...
    questions: [
      {
        ...
        levels: [
          ...
          'A supply chain competency framework defines technical and leadership competencies for major role families; it is used in annual performance reviews and development planning.',
          'A comprehensive supply chain competency framework (including digital literacy and sustainability) is applied consistently in recruitment, performance management, and development planning; gap analysis is conducted annually.',
          'A best-in-class supply chain competency framework aligned to CIPS/APICS standards is refreshed annually; digital and sustainability competencies evolve with business needs; the framework drives talent decisions across the entire lifecycle.',
        ],
        levelsAr: [
          ...
          'إطار كفاءات سلسلة إمداد يُعرّف الكفاءات التقنية والقيادية لعائلات الأدوار الرئيسية؛ ويُستخدَم في مراجعات الأداء السنوية وتخطيط التطوير.',
          'إطار كفاءات شامل لسلسلة الإمداد (شاملًا المحو الأمية الرقمية والاستدامة) يُطبَّق باتساق في التعيين وإدارة الأداء وتخطيط التطوير؛ وتحليل الفجوات يُجرى سنويًا.',
          'إطار كفاءات سلسلة إمداد بمستوى الأفضل في الفئة مواءَم مع معايير CIPS/APICS يُحدَّث سنويًا؛ والكفاءات الرقمية والاستدامة تتطوّر مع احتياجات العمل؛ والإطار يُوجّه قرارات المواهب عبر دورة الحياة الكاملة.',
        ],
      },
    ],
  },
  ...
  /* ── 10-3  Talent Attraction & Retention ─────────────────────────────── */
  {
    ...
    hintAr: 'يقيّم العلامة التجارية لأصحاب العمل في سلسلة الإمداد وقوة خط أنابيب المواهب وجودة الاستقبال وإدارة معدل الاستقالة.',
    benchmarks: { gcc: 2.3, topQuartile: 4.0 },
    industryWeights: {
      manufacturing: 1.5, fmcg: 1.5, pharma: 1.5, retail: 1.0,
      logistics: 1.5, marine: 1.5, construction: 1.0, oil_gas: 1.5,
    ...
    questions: [
      {
        ...
        qAr: 'ما مدى فعالية مؤسستكم في استقطاب المواهب المؤهلة لسلسلة الإمداد — شاملًا العلامة التجارية لأصحاب العمل والشراكات الجامعية وخط أنابيب السعودة والمقارنة التعويضية التنافسية؟',
        levels: [
        ...
        levelsAr: [
          'لا استراتيجية استباقية لاستقطاب مواهب سلسلة الإمداد. الوظائف الشاغرة تُملأ بشكل تفاعلي عبر لوحات الوظائف دون علامة تجارية لأصحاب العمل أو تطوير خط أنابيب.',
          'التوظيف يُدار عبر القنوات القياسية (LinkedIn ووكالات توظيف) لكن لا علامة تجارية لأصحاب العمل أو خط أنابيب مواهب خاص بسلسلة الإمداد.',
          'علامة تجارية محددة لأصحاب العمل في سلسلة الإمداد تُوصَّل عبر التوظيف الموجَّه؛ وعلاقات مع 2-3 جامعات تُخرّج خريجي سلسلة الإمداد مُحافَظ عليها؛ وخط أنابيب التوظيف للسعودة متابَع.',
          ...
          'علامة تجارية لأصحاب العمل في سلسلة الإمداد بمستوى الأفضل في الفئة بتقدير وطني؛ وبرامج منظمة للخريجين والمتدربين؛ واستهداف المواهب بالذكاء الاصطناعي؛ ومقارنة الإجمالي التعويضي مُحدَّثة سنويًا؛ وخط أنابيب السعودة يتجاوز المستهدفات التنظيمية.',
        ],
      },
      {
...
export const FLEET_OPS_SUB_SEGMENTS: SubSegmentData[] = [
  ...
  /* ── fleet_ops-4  Last-mile & Urban Delivery ─────────────────────────── */
  {
    ...
    titleAr: 'التوصيل للميل الأخير والتوصيل الحضري',
    hint: 'Assesses last-mile delivery performance, route density optimisation, customer experience, and sustainable urban delivery practices.',
    hintAr: 'يقيس أداء توصيل الميل الأخير وتحسين كثافة المسار وتجربة العملاء وممارسات التوصيل الحضري المستدام.',
    ...
    questions: [
      {
        q: 'How mature is your last-mile and urban delivery management — measuring first-attempt delivery rate, customer satisfaction, cost-per-delivery, route optimisation technology, and sustainability of delivery options?',
        qAr: 'ما مدى نضج إدارة التوصيل للميل الأخير والتوصيل الحضري — بقياس معدل التسليم من أول محاولة ورضا العملاء والتكلفة لكل توصيل وتقنية تحسين المسار واستدامة خيارات التوصيل؟',
        levels: [
          'Last-mile delivery is fully outsourced with no performance tracking. Customer delivery issues are handled reactively with no SLA.',
          ...
          'Last-mile KPIs (first-attempt delivery rate, customer satisfaction) are tracked; route density analysis is conducted periodically; customers are notified of major delays.',
          'Route optimisation tools improve density; first-attempt delivery rate ≥90%; real-time customer tracking is available; delivery failure root causes are analysed.',
        ...
        levelsAr: [
          'التوصيل للميل الأخير مُعهَد به خارجيًا بالكامل دون متابعة أداء. مشكلات توصيل العملاء تُعالَج تفاعليًا دون اتفاقية مستوى خدمة.',
          ...
          'تُتابَع مؤشرات الميل الأخير (معدل التسليم من أول محاولة ورضا العملاء)؛ ويُجرى تحليل كثافة المسار دوريًا؛ ويُخطَر العملاء بالتأخيرات الكبيرة.',
          'أدوات تحسين المسار تُحسّن الكثافة؛ ومعدل التسليم من أول محاولة ≥90%؛ وتتبّع العملاء الآني متاح؛ والأسباب الجذرية لفشل التسليم تُحلَّل.',
          'توجيه مُحسَّن بالذكاء الاصطناعي للميل الأخير يحقق ≥97% تسليم من أول محاولة؛ وتتبّع آني للعملاء مع إعادة جدولة ديناميكية؛ وخيارات توصيل مستدامة (EV ونقاط توحيد) مُنشَأة ومتابَعة.',
        ],
      },
    ],
  },
...
export const REGULATORY_SUB_SEGMENTS: SubSegmentData[] = [
  ...
  /* ── regulatory-0  Nitaqat / Saudization Compliance ─────────────────── */
  {
    ...
    hintAr: 'يقيم صرامة تتبّع الامتثال لنطاقات حسب وظيفة سلسلة الإمداد وإدارة خط أنابيب السعودة الاستباقية ومواءَمة القوى العاملة مع رؤية 2030.',
    benchmarks: { gcc: 2.5, topQuartile: 4.1 },
    industryWeights: {
      manufacturing: 1.5, fmcg: 1.5, pharma: 1.5, retail: 1.5,
      logistics: 1.5, marine: 1.5, construction: 1.5, oil_gas: 1.5,
    ...
    questions: [
      {
        ...
        levelsAr: [
          ...
          'تتبّع السعودة آلي حسب القسم؛ وخطوط أنابيب توظيف سلسلة الإمداد تدير مستهدفات نطاقات استباقيًا؛ والامتثال يُراجَع فصليًا على المستوى التنفيذي.',
          'إدارة استباقية لنطاقات تُحافظ على حالة المميزة/البلاتينية؛ وخط أنابيب مواهب سلسلة إمداد سعودية منظم مرتبط بخطط القوى العاملة لرؤية 2030؛ والسعودة مؤشر في بطاقة الأداء التنفيذية.',
        ],
      },
      {
        ...
        qAr: 'ما مدى فعالية بناء وإدارة خط أنابيب مواهب سلسلة الإمداد السعودي — شاملًا الشراكات الجامعية وبرامج تطوير الخريجين والتدريب الموجَّه للأدوار التقنية في سلسلة الإمداد والتعاقب من المواهب الوافدة إلى السعودية؟',
        levels: [
        ...
        levelsAr: [
          'لا يوجد خط أنابيب مواهب سلسلة إمداد سعودي. الاعتماد على الوافدين مرتفع ولا توجد خطة تعاقب سعودة للأدوار التقنية.',
          ...
          'برنامج تطوير مواهب سلسلة إمداد سعودية يستهدف 2-3 عائلات أدوار تقنية؛ والشراكات الجامعية توفر خط أنابيب توظيف خريجين؛ والتوجيه والإرشاد المنظمان قائمان.',
          ...
          'المواهب السعودية هي خط الأنابيب الرئيسي لجميع أدوار سلسلة الإمداد؛ وأكاديمية سلسلة إمداد تُطوّر السعوديين للقيادة؛ وتنفيذيو سلسلة الإمداد السعوديون يُرشدون المواهب السعودية؛ والسعودة في الأدوار العليا لسلسلة الإمداد تتجاوز 70%.',
        ],
      },
    ],
  },
