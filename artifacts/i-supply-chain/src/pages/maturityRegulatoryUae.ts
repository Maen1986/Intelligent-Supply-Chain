 ...
 *
 * LIVE PRIMARY-SOURCE CHECK (2026-08-13): this module was re-checked against
 * current regulator pages and law texts on 2026-08-13. One figure in the
 * Government Procurement sub-segment was found to be fabricated (a specific
 * "minimum three years' experience" tender-eligibility threshold that does not
 * appear in Cabinet Resolution No. 122/2024 Article 8) and has been corrected
 * to reflect the actual prequalification criteria (financial solvency,
 * technical capability, and project experience, evaluated case-by-case rather
 * than via a fixed experience-year threshold). This primary-source check is
 * stronger than the original AI-authored draft but still does not replace
 * independent named human legal/expert review — coverage_level stays 'partial'
 * and verified_by stays unset until that review happens.
 */
  ...
  /* ── 14U.5  Government Procurement (Federal / Abu Dhabi / Dubai) ─── */
  {
    ...
    questions: [
      ...
      },
      {
        ...
        qAr: 'ما مدى اكتمال احتفاظ مؤسستكم بأدلة التأهيل المسبق (سجلات العقود المنجزة، وثائق القدرة الفنية والمالية، والسجل الحافل بمشاريع مماثلة) التي تُقيّمها المناقصات الاتحادية والإماراتية بموجب معايير مثل الملاءة المالية والقدرة الفنية وخبرة المشاريع؟',
        levels: [
          ...
          'A central, organised record of completed-contract records and technical/financial capacity documentation supports prequalification claims for every relevant tender.',
        ...
        levelsAr: [
          ...
          'سجل مركزي ومنظم لسجلات العقود المنجزة ووثائق القدرة الفنية/المالية يدعم مطالبات التأهيل المسبق لكل مناقصة ذات صلة.',
