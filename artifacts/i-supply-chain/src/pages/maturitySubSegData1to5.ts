    ...
    questions: [
      {
        ...
        levelsAr: [
          ...
          'تستخدم المراجعات نصف السنوية نمذجة التوأم الرقمي ومحاكاة السيناريوهات المتعددة لتحسين النطاق التشغيلي للشبكة بشكل مستمر؛ وتُغذّي النتائج مباشرةً خطة تخصيص رأس المال.',
        ],
      },
      {
        ...
        qAr: 'ما مدى فعالية استخدامكم للنمذجة الكمية لتقييم مفاضلات التكلفة والخدمة والمخاطر قبل اتخاذ قرارات النطاق التشغيلي للشبكة (مثل المنشآت الجديدة والتوحيد والتوطين القريب)؟',
        levels: [
