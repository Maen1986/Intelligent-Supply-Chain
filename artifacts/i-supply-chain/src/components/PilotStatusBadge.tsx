    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            {/* Owner's call (1 Sep 2026): the full "Pilot - Active
             *  Development" label must render at every width -- no
             *  shortened chip, no hiding. Any header-width pressure at any
             *  breakpoint must be solved elsewhere in the header, never by
             *  shrinking or hiding this badge. */}
