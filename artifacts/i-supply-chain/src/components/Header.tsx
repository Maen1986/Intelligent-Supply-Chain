...
const servicesList = [
  ...
  { key: 'nav.supplierRecoveryPortfolio', href: '/supplier-recovery-portfolio', label: '🔄 Supplier Recovery Portfolio' },
  { key: 'nav.supplierCOPQ', href: '/supplier-copq', label: '💰 Supplier COPQ' },
  { key: 'nav.raciMatrix', href: '/raci-matrix', label: '🧭 RACI Matrix' },
  { key: 'nav.preQualificationASL', href: '/pre-qualification-asl', label: '📋 Pre-Qualification & ASL' },
  { key: 'nav.onboarding', href: '/onboarding', label: '🚀 Supplier Onboarding' },
  { key: 'nav.periodicEvaluation', href: '/periodic-evaluation', label: '🗓️ Periodic Evaluation' },
...
export function Header() {
  ...
  const navLabel = (key: string) => {
    const map: Record<string, { en: string; ar: string }> = {
      ...
      'nav.supplierRecoveryPortfolio': { en: '🔄 Supplier Recovery Portfolio', ar: '🔄 محفظة تعافي الموردين' },
      'nav.supplierCOPQ': { en: '💰 Supplier COPQ', ar: '💰 تكلفة الجودة الرديئة (COPQ)' },
      'nav.raciMatrix': { en: '🧭 RACI Matrix', ar: '🧭 مصفوفة RACI' },
      'nav.preQualificationASL': { en: '📋 Pre-Qualification & ASL', ar: '📋 التأهيل المسبق والقائمة المعتمدة' },
      'nav.onboarding': { en: '🚀 Supplier Onboarding', ar: '🚀 تهيئة الموردين' },
      'nav.periodicEvaluation': { en: '🗓️ Periodic Evaluation', ar: '🗓️ التقييم الدوري' },
