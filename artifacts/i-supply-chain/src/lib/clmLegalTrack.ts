...
export const GOVERNING_LAW_TRACKS: GoverningLawTrackMeta[] = [
  ...
  // Saudi GTPL / MOF-Etimad -- government counterparty.
  {
    ...
    jurisdictionKeywords: ['saudi', 'ksa', 'kingdom of saudi arabia'],
    recommendedPractice: "Recommended real-world practice, current framework: disputes with a government counterparty default to the Board of Grievances (Diwan Al-Mazalim) within the Saudi court system; arbitration is only available if the Minister of Finance approves it for that specific contract -- do not assume an arbitration clause is enforceable against a government entity without that sign-off. All bidding and procurement runs through the Etimad e-procurement portal (Ministry of Finance, launched 2018). Live legal-reform flag: the Council of Ministers approved a new Government Tenders and Procurement Law on 4 Aug 2026, intended to modernize the prior framework and strengthen transparency and equal opportunity in tenders -- as of this research (26 Aug 2026) implementing regulations had not yet been published, so the Board-of-Grievances/Minister-of-Finance-approval framework above is the current, still-operative practice; revisit once the implementing regulations are published. Procurement-method update within that same reform (sourced 29 Aug 2026, Greenberg Traurig client alert, 10 Aug 2026): the direct-purchase threshold rises tenfold, from SAR 100,000 to SAR 1,000,000, and the limited-tendering method is being expanded to permit direct contracting with independent professionals -- both raise the value bar below which no competitive tender is legally required at all, a distinct question from which RFx type (RFI/RFP/RFQ) applies once a competitive process is triggered. This threshold change has also not yet taken effect (in force 120 days after Official Gazette publication, date not yet confirmed as of this research).",
    recommendedPracticeAr: "الممارسة العملية الموصى بها ضمن الإطار الحالي: تُحال المنازعات مع طرف حكومي افتراضياً إلى ديوان المظالم ضمن النظام القضائي السعودي؛ ولا يتاح اللجوء إلى التحكيم إلا بموافقة وزير المالية على ذلك العقد تحديداً -- فلا يُفترض نفاذ بند التحكيم ضد جهة حكومية دون تلك الموافقة. تُدار جميع عمليات المنافسات والمشتريات عبر بوابة اعتماد الإلكترونية (وزارة المالية، أُطلقت عام 2018). تنبيه لتطور تشريعي جارٍ: وافق مجلس الوزراء بتاريخ 4 أغسطس 2026 على نظام جديد للمنافسات والمشتريات الحكومية يهدف إلى تحديث الإطار السابق وتعزيز الشفافية وتكافؤ الفرص في المنافسات -- وحتى تاريخ هذا البحث (26 أغسطس 2026) لم تُنشر بعد اللائحة التنفيذية، لذا يبقى إطار ديوان المظالم/موافقة وزير المالية أعلاه هو الممارسة النافذة حالياً؛ وتجدر إعادة النظر فور نشر اللائحة التنفيذية. تحديث في أسلوب الشراء ضمن الإصلاح ذاته (مصدره 29 أغسطس 2026، تنبيه عملاء من مكتب Greenberg Traurig بتاريخ 10 أغسطس 2026): يرتفع حد الشراء المباشر عشرة أضعاف، من 100,000 ريال إلى 1,000,000 ريال، ويجري توسيع أسلوب المنافسة المحدودة للسماح بالتعاقد المباشر مع مهنيين مستقلين -- وكلاهما يرفع الحد القيمي الذي لا تُشترط تحته أي منافسة تنافسية أصلاً، وهي مسألة مختلفة عن نوع طلب المنافسة (RFI/RFP/RFQ) الذي يُستخدم متى استوجب الأمر إجراء تنافسياً. هذا التغيير في الحدود لم يدخل بعد حيز النفاذ أيضاً (يسري بعد 120 يوماً من نشره في الجريدة الرسمية، وتاريخ النشر لم يتأكد بعد حتى إعداد هذا البحث).",
  },
  ...
  // Tier 2 wave 2 (NEW, 28 Aug 2026, registry #387 continuation): five
  // more named tracks -- Canada splits into two, like UAE onshore/DIFC,
  // because common-law provinces and civil-law Quebec are genuinely
  // different legal systems, not variants of one statute. Chosen for
  // realistic GCC cross-border relevance (trade/investment ties, common
  // choice-of-law destinations). Still open after this wave: most of
  // Asia (Japan, SE Asia beyond Singapore, Pakistan, etc.), most of
  // Africa (Nigeria, Kenya, Morocco, etc.), Latin America, New
  // Zealand/Oceania beyond Australia -- see registry #387.
  {
    id: 'canada-common-law', label: 'Canada common law (province-specific Sale of Goods Act, e.g. Ontario)', labelAr: 'القانون العام الكندي (قانون بيع البضائع الخاص بالمقاطعة، مثل أونتاريو)',
    jurisdictionKeywords: ['canada', 'ontario', 'british columbia', 'alberta'],
    recommendedPractice: "Recommended real-world practice: Canada has no single national sale-of-goods statute -- nine common-law provinces/territories each have their own Sale of Goods Act (e.g. Ontario's Sale of Goods Act, R.S.O. 1990, c. S.1, modeled on the UK's 1893 Act), so a governing-law clause must name a specific province (commonly Ontario) rather than \"Canada\" generally. Canada is a full CISG Contracting State (party since 1992, implemented federally and mirrored in each province's own International Sale of Goods Contracts Act), and CISG applies automatically to international sales unless expressly excluded -- so make an affirmative CISG election (opt in or opt out) exactly as with a US/UCC counterparty, since silence defaults to CISG, not to the named province's Sale of Goods Act. Standard neutral arbitration institution is the ICC (International Court of Arbitration); ICDR Canada (the AAA/ICDR's Canadian affiliate) is the common domestically-flavored alternative.",
    recommendedPracticeAr: "الممارسة العملية الموصى بها: لا يوجد في كندا قانون وطني موحّد لبيع البضائع -- إذ يمتلك كل من المقاطعات والأقاليم العرفية التسع قانون بيع بضائع خاصاً به (مثل قانون بيع البضائع لمقاطعة أونتاريو، R.S.O. 1990، الفصل S.1، المستمد من القانون البريطاني لعام 1893)، لذا يجب أن ينص بند القانون الحاكم على مقاطعة محددة (غالباً أونتاريو) بدلاً من \"كندا\" بشكل عام. كندا دولة طرف كاملة العضوية في اتفاقية البيع الدولي للبضائع (CISG) (انضمت عام 1992، ونُفذت اتحادياً وفي كل مقاطعة عبر قانونها الخاص لعقود البيع الدولي للبضائع)، وتنطبق CISG تلقائياً على عمليات البيع الدولية ما لم يُستبعد ذلك صراحة -- لذا يُنصح باتخاذ قرار صريح بشأن CISG (اختيارها أو استبعادها) تماماً كما هو الحال مع طرف مقابل خاضع للقانون التجاري الموحد الأمريكي، إذ يفترض السكوت تطبيق CISG وليس قانون بيع البضائع الخاص بالمقاطعة المسمّاة. جهة التحكيم المحايدة المعتادة هي غرفة التجارة الدولية (ICC)؛ ويُعد مركز ICDR كندا (الفرع الكندي التابع لـ AAA/ICDR) البديل المحلي الشائع.",
  },
  {
    id: 'canada-quebec-civil', label: 'Canada -- Civil Code of Quebec (civil-law province)', labelAr: 'كندا -- القانون المدني لمقاطعة كيبيك (مقاطعة ذات نظام مدني)',
    jurisdictionKeywords: ['quebec', 'québec'],
    recommendedPractice: "Recommended real-world practice: Quebec is Canada's one civil-law jurisdiction -- contracts governed by Quebec law fall under the Civil Code of Quebec (in force since 1994, sale provisions at arts. 1708 et seq.), not any common-law province's Sale of Goods Act, and this is a genuinely different legal system, not a variant statute -- treat it as distinct from 'Canada common law' the same way DIFC/ADGM is treated as distinct from onshore UAE law. Quebec's implementing legislation for CISG (the federal International Sale of Goods Contracts Convention Act applies there too) means CISG still governs international sales by default unless excluded, same election logic as the rest of Canada. Contracts and many public filings involving a Quebec counterparty commonly require or strongly favor a French-language version under Quebec's Charter of the French Language (Bill 96, 2022 amendments strengthened this); confirm bilingual drafting requirements early rather than assuming an English-only contract is fully enforceable end-to-end. Same ICC / ICDR Canada arbitration-institution guidance as Canada common law applies.",
    recommendedPracticeAr: "الممارسة العملية الموصى بها: كيبيك هي الاختصاص القضائي الكندي الوحيد ذو النظام المدني -- إذ تخضع العقود الحاكمة بقانون كيبيك للقانون المدني لكيبيك (الساري منذ عام 1994، وأحكام البيع فيه بدءاً من المادة 1708 وما يليها)، وليس لقانون بيع البضائع الخاص بأي مقاطعة ذات نظام عام، وهو نظام قانوني مختلف حقاً وليس مجرد صيغة أخرى من قانون واحد -- يُنصح بمعاملته كمسار مستقل عن \"كندا (القانون العام)\" تماماً كما يُعامل مركز دبي المالي العالمي/سوق أبوظبي العالمي كمسار مستقل عن القانون الإماراتي البري. لا يزال تشريع كندا التنفيذي لاتفاقية CISG (قانون اتفاقية عقود البيع الدولي للبضائع الاتحادي) سارياً في كيبيك أيضاً، ما يعني استمرار تطبيق CISG افتراضياً على عمليات البيع الدولية ما لم تُستبعد، بنفس منطق الاختيار المتبع في بقية كندا. غالباً ما تتطلب العقود والعديد من الإيداعات الرسمية المتعلقة بطرف مقابل من كيبيك نسخة باللغة الفرنسية أو تفضّلها بقوة بموجب ميثاق اللغة الفرنسية لكيبيك (تعديلات مشروع القانون 96 لعام 2022 عزّزت هذا الاشتراط)؛ يُنصح بالتحقق من متطلبات الصياغة ثنائية اللغة مبكراً بدلاً من افتراض أن عقداً بالإنجليزية فقط نافذ بالكامل. تنطبق نفس إرشادات جهة التحكيم (ICC / مركز ICDR كندا) المتبعة في القانون العام الكندي.",
  },
  {
    id: 'australia-common-law', label: 'Australia common law (state Sale of Goods Act + Australian Consumer Law overlay)', labelAr: 'القانون العام الأسترالي (قانون بيع البضائع الخاص بالولاية مع تطبيق قانون المستهلك الأسترالي الاتحادي)',
    jurisdictionKeywords: ['australia', 'nsw', 'new south wales', 'victoria'],
    recommendedPractice: "Recommended real-world practice: Australia has no single national sale-of-goods statute -- each state/territory has its own Sale of Goods Act (e.g. Sale of Goods Act 1923 (NSW), Goods Act 1958 (Vic)), so name a specific state (commonly NSW or Victoria) in the governing-law clause. A federal overlay, the Australian Consumer Law (Schedule 2 to the Competition and Consumer Act 2010 (Cth), amended as recently as 2023 to extend unfair-contract-terms protections to standard-form small-business contracts), applies on top and its mandatory consumer guarantees generally cannot be excluded even in some B2B contracts -- factor this into standard-form terms rather than assuming full freedom of contract. Australia acceded to CISG in 1988 (in force 1989), but Australian-drafted commercial contracts very commonly and deliberately exclude CISG in favor of state Sale of Goods Act/common law -- the opposite default assumption a GCC drafter may expect -- so confirm the CISG treatment explicitly rather than assuming it applies. Standard dispute-resolution forum is ACICA (Australian Centre for International Commercial Arbitration).",
    recommendedPracticeAr: "الممارسة العملية الموصى بها: لا يوجد في أستراليا قانون وطني موحّد لبيع البضائع -- إذ يمتلك كل ولاية/إقليم قانون بيع بضائع خاصاً به (مثل قانون بيع البضائع لعام 1923 في نيو ساوث ويلز، وقانون البضائع لعام 1958 في فيكتوريا)، لذا يجب تسمية ولاية محددة (غالباً نيو ساوث ويلز أو فيكتوريا) في بند القانون الحاكم. يُطبَّق فوق ذلك إطار اتحادي هو قانون المستهلك الأسترالي (الملحق 2 من قانون المنافسة والمستهلك لعام 2010 الاتحادي، الذي عُدِّل مؤخراً عام 2023 لتوسيع حماية الشروط التعاقدية غير العادلة لتشمل عقود الشركات الصغيرة ذات الصيغة الموحدة)، وتُعد ضماناته الإلزامية للمستهلك غير قابلة للاستبعاد عموماً حتى في بعض العقود بين الشركات -- يُنصح بمراعاة ذلك عند صياغة الشروط الموحدة بدلاً من افتراض حرية تعاقدية كاملة. انضمت أستراليا إلى اتفاقية CISG عام 1988 (سريانها من 1989)، إلا أن العقود التجارية الأسترالية كثيراً ما تستبعد CISG عمداً لصالح قانون بيع البضائع الخاص بالولاية أو القانون العام -- وهو عكس الافتراض الذي قد يتوقعه صائغ خليجي -- لذا يُنصح بالتحقق صراحة من معاملة CISG بدلاً من افتراض انطباقها. جهة تسوية المنازعات المعتادة هي المركز الأسترالي للتحكيم التجاري الدولي (ACICA).",
  },
  {
    id: 'singapore-sga', label: 'Singapore Sale of Goods Act 1979 (Cap. 393)', labelAr: 'قانون بيع البضائع السنغافوري لعام 1979 (الفصل 393)',
    jurisdictionKeywords: ['singapore'],
    recommendedPractice: "Recommended real-world practice: Singapore is a unified common-law jurisdiction (no state/provincial split) governed by the Sale of Goods Act 1979 (Cap. 393, based on the UK's 1979 Act, revised edition current through 2021's Act 25, in force 1 Apr 2022). Singapore acceded to CISG in 1995 (implemented via the Sale of Goods (United Nations Convention) Act, Cap. 283A) but made an Article 95 reservation: CISG applies only when both parties' places of business are in CISG Contracting States, not merely on private-international-law grounds. Practically for GCC counterparties: since Saudi Arabia, UAE, Qatar, Oman, and Kuwait are not CISG parties, CISG will not automatically apply to a Singapore-GCC contract regardless of Singapore's reservation -- parties must expressly elect CISG or the Singapore Sale of Goods Act if that outcome is wanted, rather than assuming CISG fills the gap by default. Standard dispute-resolution forum is SIAC (Singapore International Arbitration Centre), which has an active MOU with ADGM and a growing GCC/Middle East caseload -- a natural pairing for GCC-Asia cross-border contracts.",
    recommendedPracticeAr: "الممارسة العملية الموصى بها: سنغافورة اختصاص قضائي عام موحّد (بلا تقسيم إلى ولايات أو مقاطعات) يحكمه قانون بيع البضائع لعام 1979 (الفصل 393، المستمد من القانون البريطاني لعام 1979، وطبعته المنقحة سارية حتى تعديل القانون رقم 25 لعام 2021 الذي دخل حيز التنفيذ في 1 أبريل 2022). انضمت سنغافورة إلى اتفاقية CISG عام 1995 (نُفذت عبر قانون بيع البضائع (اتفاقية الأمم المتحدة)، الفصل 283A) لكنها أبدت تحفظاً بموجب المادة 95: لا تنطبق CISG إلا عندما يقع مقرا عمل الطرفين في دولتين طرفين في الاتفاقية، وليس لمجرد اعتبارات القانون الدولي الخاص. عملياً بالنسبة للأطراف الخليجية: نظراً لأن السعودية والإمارات وقطر وعُمان والكويت ليست أطرافاً في CISG، فلن تنطبق CISG تلقائياً على عقد بين سنغافورة وطرف خليجي بصرف النظر عن تحفظ سنغافورة -- يجب على الطرفين اختيار CISG أو قانون بيع البضائع السنغافوري صراحة إذا كانت هذه هي النتيجة المرغوبة، بدلاً من افتراض أن CISG تسد الفراغ تلقائياً. جهة تسوية المنازعات المعتادة هي مركز سنغافورة الدولي للتحكيم (SIAC)، الذي يمتلك مذكرة تفاهم فعّالة مع سوق أبوظبي العالمي وقاعدة قضايا خليجية/شرق أوسطية متنامية -- ما يجعله اقتراناً طبيعياً للعقود العابرة للحدود بين الخليج وآسيا.",
  },
  {
    id: 'turkey-tbk-ttk', label: 'Turkey -- Code of Obligations (TBK 6098) + Commercial Code (TTK 6102)', labelAr: 'تركيا -- قانون الالتزامات التركي (6098) وقانون التجارة التركي (6102)',
    jurisdictionKeywords: ['turkey', 'türkiye', 'turkiye'],
    recommendedPractice: "Recommended real-world practice: Turkey is a civil-law system -- the Turkish Code of Obligations No. 6098 (TBK, 2011) governs general contract formation, performance, and breach, with the Turkish Commercial Code No. 6102 (TTK, 2012, periodically amended) layering merchant-specific commercial-sale rules on top. Turkey has been a CISG Contracting State since 1 Aug 2011, and CISG applies by default to international sales between Turkey and other CISG states unless expressly excluded. The single most important practical drafting point: TTK sets very short merchant defect-notice periods -- 2 days for apparent defects, 8 days for hidden defects -- far shorter than typical GCC or Western commercial practice, so a GCC supplier selling into Turkey under Turkish law should build fast inspection-and-notification procedures into the contract or risk losing defect claims purely through delay. Standard dedicated dispute-resolution forum is ISTAC (Istanbul Arbitration Centre); note the ICC remains, historically, the most-chosen institution for Turkish cross-border disputes generally, so either is a defensible choice depending on the counterparty's preference.",
    recommendedPracticeAr: "الممارسة العملية الموصى بها: تركيا دولة ذات نظام قانوني مدني -- يحكم قانون الالتزامات التركي رقم 6098 (TBK، 2011) تكوين العقد العام وتنفيذه والإخلال به، بينما يضيف قانون التجارة التركي رقم 6102 (TTK، 2012، ويُعدَّل بشكل دوري) قواعد خاصة بالبيع التجاري بين التجار فوق ذلك الإطار. تركيا دولة طرف في اتفاقية CISG منذ 1 أغسطس 2011، وتنطبق الاتفاقية افتراضياً على عمليات البيع الدولية بين تركيا ودول أخرى طرف في CISG ما لم تُستبعد صراحة. أهم نقطة عملية في الصياغة: يحدد قانون التجارة التركي مهلاً قصيرة جداً لإخطار التاجر بالعيوب -- يومان للعيوب الظاهرة وثمانية أيام للعيوب الخفية -- وهي أقصر بكثير من الممارسة التجارية المعتادة في الخليج أو الغرب، لذا يُنصح للمورد الخليجي البائع إلى تركيا بموجب القانون التركي بتضمين العقد إجراءات فحص وإخطار سريعة، وإلا فقد يخسر مطالبات العيوب لمجرد التأخير. جهة تسوية المنازعات المخصصة المعتادة هي مركز إسطنبول للتحكيم (ISTAC)؛ مع ملاحظة أن غرفة التجارة الدولية (ICC) تبقى تاريخياً الجهة الأكثر اختياراً للمنازعات التركية العابرة للحدود بشكل عام، لذا يُعد كلاهما خياراً معقولاً حسب تفضيل الطرف المقابل.",
  },
...
export const ARBITRATION_INSTITUTIONS: ArbitrationInstitutionMeta[] = [
  ...
  { id: 'icdr-canada', label: 'ICDR Canada (AAA/ICDR Canadian affiliate)', labelAr: 'مركز ICDR كندا (الفرع الكندي التابع لـ AAA/ICDR)' },
  { id: 'acica', label: 'ACICA (Australian Centre for International Commercial Arbitration)', labelAr: 'المركز الأسترالي للتحكيم التجاري الدولي (ACICA)' },
  { id: 'siac', label: 'SIAC (Singapore International Arbitration Centre)', labelAr: 'مركز سنغافورة الدولي للتحكيم (SIAC)' },
  { id: 'istac', label: 'ISTAC (Istanbul Arbitration Centre)', labelAr: 'مركز إسطنبول للتحكيم (ISTAC)' },
...
export const COMMON_CONTRACTING_COMBOS: CommonContractingCombo[] = [
  ...
  { id: 'canada-icc', labelEn: 'Canada common law (Ontario) + ICC arbitration', labelAr: 'القانون العام الكندي (أونتاريو) + تحكيم ICC',
    governingLaw: 'canada-common-law', arbitrationInstitution: 'icc', disputeResolutionVariant: 'institutional-arbitration' },
  { id: 'quebec-icc', labelEn: 'Quebec Civil Code + ICC arbitration', labelAr: 'القانون المدني لكيبيك + تحكيم ICC',
    governingLaw: 'canada-quebec-civil', arbitrationInstitution: 'icc', disputeResolutionVariant: 'institutional-arbitration' },
  { id: 'australia-acica', labelEn: 'Australia common law (NSW) + ACICA arbitration', labelAr: 'القانون العام الأسترالي (نيو ساوث ويلز) + تحكيم ACICA',
    governingLaw: 'australia-common-law', arbitrationInstitution: 'acica', disputeResolutionVariant: 'institutional-arbitration' },
  { id: 'singapore-siac', labelEn: 'Singapore Sale of Goods Act + SIAC arbitration', labelAr: 'قانون بيع البضائع السنغافوري + تحكيم SIAC',
    governingLaw: 'singapore-sga', arbitrationInstitution: 'siac', disputeResolutionVariant: 'institutional-arbitration' },
  { id: 'turkey-istac', labelEn: 'Turkey TBK/TTK + ISTAC arbitration', labelAr: 'القانون التركي (TBK/TTK) + تحكيم ISTAC',
    governingLaw: 'turkey-tbk-ttk', arbitrationInstitution: 'istac', disputeResolutionVariant: 'institutional-arbitration' },
];
